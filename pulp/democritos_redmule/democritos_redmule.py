...
# LightRedmule plus a simulation-only integer format.

class DemocritosRedmule(gvsoc.systree.Component):
    ...
    def __init__(self,
        ...
        self.add_sources(['pulp/democritos_redmule/democritos_redmule.cpp'])
